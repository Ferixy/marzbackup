...
7z a -spf -p"$pass" -mhe=on -t7z -m0=lzma2 /root/marzbackup/MarzbanBackup.7z /etc/wireguard /opt/marzban /opt/marzban/.env /var/lib/marzban /root/marzbackup/db-backup/* /etc/nginx /etc/haproxy /etc/sysctl.conf /root/marzbackup/crontabbackup.txt /var/lib/vnstat /opt/tblocker /etc/letsencrypt/live /etc/netplan /etc/rsyslog.d /etc/systemd/system /etc/apt/sources.list.d /etc/resolv.conf /etc/systemd/resolved.conf -x\!/var/lib/marzban/mysql 
...
rm /root/marzbackup/crontabbackup.txt  >/dev/null 2>&1
crontab -l > /root/marzbackup/crontabbackup.txt
7z a -spf -p"$pass" -mhe=on -t7z -m0=lzma2 /root/marzbackup/MarzbanBackup.7z /etc/wireguard /opt/marzban /opt/marzban/.env /var/lib/marzban /etc/nginx /etc/haproxy /etc/sysctl.conf /root/marzbackup/crontabbackup.txt /var/lib/vnstat /opt/tblocker /etc/letsencrypt/live /etc/netplan /etc/rsyslog.d /etc/systemd/system /etc/apt/sources.list.d /etc/resolv.conf /etc/systemd/resolved.conf
EOF
)
fi
