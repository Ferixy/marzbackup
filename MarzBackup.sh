...
7z a -p"$pass" -mhe=on -t7z -m0=lzma2 /root/marzbackup/MarzbanBackup.7z -x!/var/lib/marzban/mysql/** /etc/wireguard/* /opt/marzban/* /opt/marzban/.env /var/lib/marzban/* /root/marzbackup/db-backup/* /etc/nginx /etc/haproxy /etc/sysctl.conf 
